# This file is taken from https://github.com/vqdang/hover_net/blob/master/src/metrics/stats_utils.py
# Created by Graham, Simon and Vu, Quoc Dang and Raza, Shan E Ahmed and Azam, Ayesha and Tsang, Yee Wah and Kwak, Jin Tae and Rajpoot, Nasir
